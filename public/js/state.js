let state_list = [
    { name: 'Andaman and Nicobar Island', code: 'AN' },
    { name: 'Andhra Pradesh', code: 'AP' },
    { name: 'Arunanchal Pradesh', code: 'AR' },
    { name: 'Assam', code: 'AS' },
    { name: 'Bihar', code: 'BR' },
    ...
    { name: 'Jharkhnad', code: 'JH' },
    { name: 'Karnatka', code: 'KA' },
    { name: 'Kerala', code: 'KL' },
...
function createstateList(){
    const num_countries = state_list.length;
    let i=0, ul_list_id;
    ...
    state_list.forEach( (state,index)=>{
        ...
        <li onclick= "getInfo('${state.code}')" id="${state.name}">
        ${state.name}
        </li>
        `;
    })
